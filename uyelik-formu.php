...
<body>
    <?php include "includes/header.php"?>
        <div class="uyelik-ustresim ">
            
        </div>
        <div class="uyelik-genel container">
            <section class="uyelik-list">
                <ul>
                    <li>
                        Sitemize Üye Olun, 
                        <br>
                    ...
                    <li>
                        <div class="uyelik-impflex">
                            ...
                            <span><h4>Yüksek Kalite / Uygun Fiyat</h4>
                    ...
                    <li>
                        <div class="uyelik-impflex">
                            ...
                            <span><h4>1 Günde Teslimat Garantisi</h4>
                    ...
                    <li>
                        <div class="uyelik-impflex">
                            ...
                            <span><h4>QR Destekli İzlenebilirlik</h4>
            ...
            <section class="uyelikformu-genel">
                <div class="uyelikformu">
                    ...
                    <div class="uyelik-kurallar">
                        ...
                        <div>
                            <input type="checkbox"><span style="text-decoration:underline;">Gizlilik Politikası metnini okudum, onaylıyorum.</span>
                        </div>
                        <div>
        ...
        <section class="uyelik-altresimgenel ">
            <div class="uyelik-altresim container">
                <div>
                    <div>
                        <div class="uyelik-impflex">
                            <span>01</span><img src="assets/images/4.png" alt="">
                        </div>
                    </div>
                ...
                <div>
                    <div>
                        <div class="uyelik-impflex">
                            <span>02</span><img src="assets/images/5.png" alt="">
                        </div>
                    </div>
                    <div class="uyelik-altyazi">
                ...
                <div>
                    <div>
                        <div class="uyelik-impflex">
                            <span>03</span><img src="assets/images/2.png" alt="">
                        </div>
                    </div>
                    <div class="uyelik-altyazi">
                        En Uygun Fiyatla
                ...
                <div>
                    <div>
                        <div class="uyelik-impflex">
                            <span>05</span><img src="assets/images/3.png" alt="">
                        </div>
                    </div>
                    <div class="uyelik-altyazi">
